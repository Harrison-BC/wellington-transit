 ...
 * 
 * Points represent pixel positions on the screen. A Point
...
public class Location {
	...
	//TODO: Change this to Wellington
	private static final double CENTRE_LAT = -41.265311;
	private static final double CENTRE_LON = 174.731230;
	...
	/**
	 * Return distance in Kms between this location and another
	 */
	...
	/**
	 * Return distance in hours between this location and another
	 * We care more about a higher speed limit than we do a higher road class,
	 * but we still take it into account as a sort of 'delay'.
	 *
	 *
	 */
	public double distanceInHours(Location other) {
		double kmDifference = this.distanceInKm(other);
		double hours = kmDifference/120; // we assume that the max is 120km/hr, and best roadClass = 4 (No )
		return hours;
	}
